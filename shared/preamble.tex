...
\tcolorboxenvironment{definition}{
	blanker, breakable, left=8pt, top=2pt, bottom=2pt, borderline west={2pt}{0pt}{DAcolor}, before skip=8pt, after skip=8pt 
}

\tcolorboxenvironment{theorem}{
	enhanced, breakable, colback=DAcolor!15, colframe=DAcolor, arc=0pt, boxrule=0.8pt,leftrule=3pt, before skip=10pt, after skip=10pt
}
\tcolorboxenvironment{proposition}{
	blanker, breakable,
	left=4mm,
	borderline west={2pt}{0pt}{DAcolor, line cap=round} 
}

\makesavenoteenv{proposition}
